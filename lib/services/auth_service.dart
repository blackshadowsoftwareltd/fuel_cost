...
class AuthService {
  ...
  static Future<Map<String, dynamic>> signIn({required String email, required String password}) async {
    ...
    //   rethrow;
    // }
    debugPrint('API calls disabled - signIn skipped');
    await _saveAuthData(userId: 'local_user', email: email);
    return {'user_id': 'local_user', 'email': email};
  }
  ...
  static Future<Map<String, dynamic>> signUp({
    ...
    // API calls commented out
    debugPrint('API calls disabled - signUp skipped');
    await _saveAuthData(userId: 'local_user', email: email);
    return {'user_id': 'local_user', 'email': email};
  }
